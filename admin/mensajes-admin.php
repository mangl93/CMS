...
<body>
  ...
  <div class="row justify-content-between" id="cabecera">
    ...
    <?php 
        ...
        elseif ( isset($_GET['enviados'] )) {
            $query="select leido,CodMen,asunto ,date_format(hora_envio,'%d %M') as dia from Mensajes 
            where Remitente = '".$_SESSION['cod']."';";
    ...
    <div class="col-2">
        ...
        <div class="col-2 "><a href="mensajes-admin.php?enviados"><button class="btn btn-info mb-1">Enviados</button></a></div>
    </div>
    </div>
    </div>
    </div>
