  ...
  <div class="container">
    ...
    <div class="row justify-content-between" id="cabecera">
      ...
      <div class="col-6  d-none" >
        <table>
          ...
          <button type="button" class="btn btn-secondary lista btn-lg">Articulos
          <a href="articulos.php">Reservas</a>
          </button>
    ...
    <div class="background">
      <div class="row justify-content-around" id="tercero">
            ...
            <div class="col-3" >
                <img src="iconos/login2.png" width="100%">
            </div>
            ...
            <?php else: ?>
              ...
              $query="SELECT pass from Usuarios where email like '%".$_POST["mail"]."'";
              ...
              if ($result = $connection->query($query)) {
                  ...
                  if ($result->num_rows==0) {
                      ...
                      if ($passwd==$_POST['pass']) {
                          ...
                          echo "<a href='principal.html'>Ir al inicio.</a>";
                      }
            ...
            <div class="col-3 login-form-2">
            <iframe src="ingresar.php" width="200px" height="300px"  style="border:0px;"></iframe>
        </div>
      </div>
    </div>
